export const posts = [
  {
    slug: "10-early-warning-signals-of-war",
    title: "10 Early Warning Signs of War Between Countries",
    excerpt:
      "Analysts monitor a set of recurring indicators that often appear before international conflicts escalate. Learn the key early warning signs of war between countries.",
    date: "2026-03-15",
    image: "/10-Early-Warning-Signs-of-War-Between-Countries.png",
    content: `## Introduction: Why Early Warning Signs Matter
...
Understanding these indicators helps readers interpret news and analysis with greater context. For more on how analysts use these signals in practice, explore our [early warning signals](/early-warning-signals) page, [conflict prediction analysis](/explore-conflict-predictions), and [geopolitical forecasting methods](/learn-forecasting-methods).`,
  },
  {
    slug: "military-buildup-indicators-before-war",
    title: "Military Buildup Indicators That Often Appear Before War",
    excerpt:
      "Troop deployments, exercises, and defense spending are among the strongest signals analysts use to assess conflict probability. Learn which military buildup indicators often appear before war.",
    date: "2026-03-16",
    image: "/military-buildup-indicators-before-war.png",
    content: `## Why Military Buildup Matters in Conflict Forecasting
...
This article outlines the military buildup indicators that frequently appear before wars or major confrontations. Understanding these signals helps readers interpret how analysts estimate conflict probability. For related analysis, see our [global conflict risk index](/explore-global-risk-index) and [early warning signals of war](/early-warning-signals).
...
No single indicator is definitive; analysts combine military data with diplomatic, economic, and political indicators to build a fuller picture of risk. For more on how these signals are used in practice, see our [early warning signs](/early-warning-signals) page, the [global conflict risk index](/explore-global-risk-index), and [geopolitical forecasting](/explore-geopolitical-forecasting) resources.`,
  },
  {
    slug: "global-conflict-risk-index-countries",
    title: "Global Conflict Risk Index: Countries Most Likely to Face Conflict",
    excerpt:
      "A structured view of geopolitical risk by region. Which countries and regions analysts rank as most likely to face conflict, and what drives those assessments.",
    date: "2026-03-17",
    image: "/Countries-Most-Likely-to-Face-Conflict.png",
    content: `## What Is a Global Conflict Risk Index?
...
Readers should treat indices as one input among many when forming views on global security. For deeper analysis on specific regions, see our [trending conflicts](/trending-conflicts) and [early warning signals](/early-warning-signals) resources.
...
For more on how analysts monitor risk in practice, explore our [Global Risk Index](/explore-global-risk-index) and [early warning signals](/early-warning-signals) pages, plus [conflict prediction analysis](/explore-conflict-predictions).`,
  },
  {
    slug: "how-prediction-markets-forecast-wars",
    title: "How Prediction Markets Forecast Wars",
    excerpt:
      "Prediction markets let participants trade on the probability of future events, including conflict. How they work, what they capture, and how analysts use them alongside other tools.",
    date: "2026-03-18",
    image: "/How-Prediction-Markets-Forecast-Wars.png",
